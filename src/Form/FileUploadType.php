...
use Eltharin\FileUploadManagerBundle\Service\FileManagerServiceLocator;
...
class FileUploadType extends AbstractType
{
	public function __construct(private ParameterBagInterface $parameterBag,
                                private FileManagerServiceLocator $fileManagerServiceLocator,
	...
	public function buildForm(FormBuilderInterface $builder, array $options): void
	{
		...
		{
			$builder->add('_delete', CheckboxType::class, ['mapped' => false, 'data' => false, 'attr' => ['checked' => false]]);
		}
